package com.github.nenidan.ne_ne_challenge.notification.application.listener;
...
import com.github.nenidan.ne_ne_challenge.notification.application.event.ChallengeClearedEvent;
...
public class NotificationEventListener {
	...
	*/
	public void handle(ChallengeClearedEvent event) {
		UserResponse userResponse = userClient.findUserById(event.getUserId());
